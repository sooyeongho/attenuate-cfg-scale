...
[note: if you're updating from an earlier version and strength parameter does not go to 2, edit lines containing attenuate_cfg_scale.py in ui-config.json]
